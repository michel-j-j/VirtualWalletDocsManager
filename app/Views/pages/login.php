...
<head>
	...
	<link rel="apple-touch-icon" sizes="60x60"
		href="https://coreui.io/demos/bootstrap/5.0/light-v3/assets/favicon/apple-icon-60x60.png">
	<link rel="apple-touch-icon" sizes="72x72"
		href="https://coreui.io/demos/bootstrap/5.0/light-v3/assets/favicon/apple-icon-72x72.png">
	<link rel="apple-touch-icon" sizes="76x76"
		href="https://coreui.io/demos/bootstrap/5.0/light-v3/assets/favicon/apple-icon-76x76.png">
	<link rel="apple-touch-icon" sizes="114x114"
		href="https://coreui.io/demos/bootstrap/5.0/light-v3/assets/favicon/apple-icon-114x114.png">
	<link rel="apple-touch-icon" sizes="120x120"
		href="https://coreui.io/demos/bootstrap/5.0/light-v3/assets/favicon/apple-icon-120x120.png">
	<link rel="apple-touch-icon" sizes="144x144"
		href="https://coreui.io/demos/bootstrap/5.0/light-v3/assets/favicon/apple-icon-144x144.png">
	<link rel="apple-touch-icon" sizes="152x152"
		href="https://coreui.io/demos/bootstrap/5.0/light-v3/assets/favicon/apple-icon-152x152.png">
	<link rel="apple-touch-icon" sizes="180x180"
		href="https://coreui.io/demos/bootstrap/5.0/light-v3/assets/favicon/apple-icon-180x180.png">
			...
			<div class="row justify-content-center">
					...
					<div class="card-group d-block d-md-flex row">
						<div class="card col-md-7 p-4 mb-0">
							...
							<div class="col-6 text-end">
								<a class="btn btn-link px-0" type="button" href="<?php echo base_url('recuperar') ?>">Te
				...
				<div class="card col-md-5 text-white bg-primary py-5">
					<div class="card-body text-center">
						<div>
							<h2>Registrarse</h2>
							<p>Desde aca podra registrarse, en nuestra applicacion. Problemas cuando se pierde tu
								documentacion? Eso ya es cosa del pasado con <strong> Perdi Mi Billetera.</strong> </p>
							<a class="btn btn-lg btn-outline-light mt-3" type="button"
								href="<?php echo base_url('register') ?>">Registrarse</a>
						</div>
					</div>
				</div>
			</div>

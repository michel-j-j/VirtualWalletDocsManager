...
<<<<<<< HEAD
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="#">Perdí Mi Billetera</a>
            <!-- Agrega un botón de inicio de sesión aquí -->
    ...
    <div class="container mt-4">
        ...
        <div class="jumbotron">
            ...
            <p class="lead">Carga tus documentos y realiza denuncias en caso de pérdida.</p>
